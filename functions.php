 ...
 * @package Sabino
 */
define( 'SABINO_THEME_VERSION' , '1.1.24' );
		...
		<div class="notice notice-info sabino-admin-notice sabino-notice-add">
			<h4>
				...
				<span>
					...
					printf( esc_html__( 'Premium is %1$s', 'sabino' ), wp_kses( __( '<a href="https://kairaweb.com/wordpress-theme/sabino/#purchase-premium" target="_blank">currently only $25</a>', 'sabino' ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ) );
					?>
				</span>
			</h4>
            <p><?php printf( __( 'We\'re here to help... Please <a href="%s">read through our help notes</a> on getting started with Sabino', 'sabino' ) , admin_url( 'themes.php?page=theme_info' ) ); ?></p>
            <p><b><?php esc_html_e( 'Sabino Premium now offers FREE shortcode slider to add slider to all or any pages you choose', 'sabino' ); ?></b></p>
