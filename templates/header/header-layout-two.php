	...
	<div class="site-top-bar">
		...
		<div class="site-container">
			...
			<div class="site-top-bar-right">
				...
				<?php if ( get_theme_mod( 'sabino-website-head-txt-sm', customizer_library_get_default( 'sabino-website-head-txt-sm' ) ) || get_theme_mod( 'sabino-website-head-txt-lg', customizer_library_get_default( 'sabino-website-head-txt-lg' ) ) ) : ?>
					<span class="site-topbar-right-no"><i class="fas <?php echo ( get_theme_mod( 'sabino-custom-phicon', customizer_library_get_default( 'sabino-custom-phicon' ) ) ) ? sanitize_html_class( get_theme_mod( 'sabino-custom-phicon', customizer_library_get_default( 'sabino-custom-phicon' ) ) ) : sanitize_html_class( 'fa-phone' ); ?>"></i> <?php echo esc_html( get_theme_mod( 'sabino-website-head-txt-sm', customizer_library_get_default( 'sabino-website-head-txt-sm' ) ) ); ?> <span><?php echo esc_html( get_theme_mod( 'sabino-website-head-txt-lg', customizer_library_get_default( 'sabino-website-head-txt-lg' ) ) ); ?></span></span>
				<?php endif; ?>
	...
	<div class="site-container header-container">
		...
		<?php else : ?>
			<nav id="site-navigation" class="main-navigation">
				...
				<span class="header-menu-button"><i class="fas fa-bars"></i><span><?php echo esc_html( get_theme_mod( 'sabino-header-menu-text', 'menu' ) ); ?></span></span>
