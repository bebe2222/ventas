    ...
    <?php if( $slider_cats ) : ?>
        ...
        <?php if ( $slider_query->have_posts() ) : ?>
            ...
            <div class="site-container slider-container">
                ...
                <div class="home-slider-wrap home-slider-remove" data-rand="<?php echo ( get_theme_mod( 'sabino-slider-random', customizer_library_get_default( 'sabino-slider-random' ) ) ) ? esc_attr( 'random' ) : esc_attr( 0 ); ?>">
                ...
                <div class="home-slider">
                    ...
                    <div class="home-slider-block" style="background-image: url(<?php echo get_stylesheet_directory_uri() ?>/images/demo/slider_default_01.jpg);">
                        ...
                        <div class="home-slider-block-inner">
                            <div class="home-slider-block-bg">
                                <h3>
                                    <?php _e( 'Welcome to Sabino', 'sabino' ); ?>
                                </h3>
                                <p><?php _e( 'Let\'s get started', 'sabino' ); ?></p>
                            </div>
                        </div>
                    ...
                    <div class="home-slider-block" style="background-image: url(<?php echo get_stylesheet_directory_uri() ?>/images/demo/slider_default_02.jpg);">
                        ...
                        <?php if ( !get_theme_mod( 'sabino-slider-remove-title' ) ) : ?>
                            ...
                            <div class="home-slider-block-inner">
                                <div class="home-slider-block-bg">
                                    <h3>
                                        <?php _e( 'Freedom to Create', 'sabino' ); ?>
                                    </h3>
                                    <p><?php _e( 'Let\'s get started', 'sabino' ); ?></p>
                                </div>
                            </div>
