    ...
    $( window ).on('load',function () {
        ...
        function sabino_customizer_slider_check( slider_select_value ) {
            if ( slider_select_value == 'sabino-slider-default' ) {
                ...
                $( '#sub-accordion-section-sabino-panel-settings-section-slider #customize-control-sabino-unote-slider' ).show();
                $( '#sub-accordion-section-sabino-panel-settings-section-slider #customize-control-sabino-slider-random' ).show();
                ...
                $( '#sub-accordion-section-sabino-panel-settings-section-slider #customize-control-sabino-unote-slider' ).hide();
                $( '#sub-accordion-section-sabino-panel-settings-section-slider #customize-control-sabino-slider-random' ).hide();
